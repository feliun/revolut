...
describe('Revolut API initialisation', () => {
  it('fails to initialise when environment is not provided', () => Promise.resolve()
    .then(() => initRevolut({}))
  ...
  it('fails to initialise when an invalid environment is provided', () => Promise.resolve()
  ...
  it('fails to initialise when an API token is not provided', () => Promise.resolve()
  ...
  it('initialises correctly when a valid environment and an API token are provided', () => Promise.resolve()
